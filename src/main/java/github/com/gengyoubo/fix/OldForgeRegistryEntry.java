...
public abstract class OldForgeRegistryEntry<V extends OldIForgeRegistryEntry<V>> implements OldIForgeRegistryEntry<V> {
    @SuppressWarnings("serial")
    private final TypeToken<V> token = new TypeToken<V>(getClass()){};
    public final OldIRegistryDelegate<V> delegate = new RegistryDelegate<>((V)this, (Class<V>)token.getRawType());
     ...
     */
    public abstract static class UncheckedRegistryEntry<V extends OldIForgeRegistryEntry<V>> extends OldForgeRegistryEntry<V> {
        @Override
        ResourceLocation checkRegistryName(String name)
        {
