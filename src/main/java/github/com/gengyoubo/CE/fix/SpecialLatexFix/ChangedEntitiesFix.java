...
public class ChangedEntitiesFix {
    ...
    private static <T extends ChangedEntity> RegistryObject<EntityType<T>> registerNoEgg(
        ...
        String regName = Changed.modResource("special_latex").toString();
        RegistryObject<EntityType<T>> entityType = REGISTRY.register("special_latex", () -> builder.build(regName));
