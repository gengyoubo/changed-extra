...
public class OldTransfurVariant<T extends ChangedEntity>  extends TransfurVariant<T>{
    ...
    private static int getIntCompat(JsonObject root) {
        JsonElement el = findFieldIgnoreCase(root, "extraJumpCharges", "extrajumpcharges");
    ...
    private static boolean getBooleanCompat(JsonObject root, String... keys) {
        JsonElement el = findFieldIgnoreCase(root, keys);
    ...
    public static OldTransfurVariant<?> fromJson(ResourceLocation id, JsonObject root, List<AbstractAbility<?>> injectAbilities) {
        ...
        boolean nightVision = getBooleanCompat(root, "nightVision", "nightvision");
        boolean weakMining = getBooleanCompat(root, "weakMining", "weakmining");
        ...
        return new OldTransfurVariant<>(
                ...
                getBooleanCompat(root, "canGlide", "canglide"),
                getIntCompat(root),
                getBooleanCompat(root, "reducedFall", "reducedfall"),
                getBooleanCompat(root, "canClimb", "canclimb"),
